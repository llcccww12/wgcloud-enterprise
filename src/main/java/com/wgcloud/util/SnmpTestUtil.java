    ...
    public static String snmpGet(SnmpInfo snmpInfo, String oid) {
        ...
        block9: {
            ...
            try {
                ...
                Target myTarget = SnmpTestUtil.createDefault(ip, community, port, snmpVersion, snmp, snmpInfo.getSecurityName(), snmpInfo.getAuthPass(), snmpInfo.getPrivPass());
                PDU request = new PDU();
                SnmpTestUtil.bindingRequestVars(request, oid);
                request.setType(-96);
